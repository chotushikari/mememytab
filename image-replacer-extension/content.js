...
function scan() { Array.from(document.images).forEach((img, i) => setTimeout(() => swap(img), Math.min(i * 22, 220))); document.querySelectorAll('[style*="background-image"], [style*="background:"]').forEach(swapBackground); }
